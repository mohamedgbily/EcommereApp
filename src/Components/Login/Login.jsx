...
// to change in design after render you must think in state as rerender
  ...
  <div className='w-75 m-auto p-5 '>
    ...
    <form onSubmit={ myLoginFormik.handleSubmit } className=' main-bg p-5 bg-form'>
      ...
      <input onBlur={myLoginFormik.handleBlur} onChange={myLoginFormik.handleChange} value={ myLoginFormik.values.password}  type="password" id='password' className='form-control mb-3' placeholder='password'/>
